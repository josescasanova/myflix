...
describe Admin::VideosController do
  describe "GET new" do
    ...
    it "sets the flash error message for hte regular user" do
      set_current_user
      get :new
  ...
  describe "POST create" do
    ...
    context "with valid inputs" do
      ...
      it "creates a video" do
        set_current_admin
        category = Fabricate(:category)
        video = Video.create(title: "Futurama", description: "space travel show")
    ...
    context "with invalid inputs" do
      it "does not create a video" do
        set_current_admin
        category = Fabricate(:category)
        video = Video.create( description: "space travel show" )
        video.categories << category
