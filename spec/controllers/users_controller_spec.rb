...
describe UsersController do
  ...
  describe "POST create" do
    ...
    context "with invalid personal info" do
      before do 
        post :create, user: { password: "password", full_name: "Jose Casanova"}
      end
      ...
      it "does not charge the card" do
        ...
        post :create, user: { email: "jose@example.com" }
      end
  ...
  describe "GET new_with_invitation_token" do
    it "renders the :new view template" do
      invitation = Invitation.create(recipient_name: 'Joe Black', recipient_email: 'joe@joejoe.com', message: 'blahblahblah')
    ...
    it "redirects to expired token page for invalid tokens" do
      get :new_with_invitation_token, token: 'asddfg'
